...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span> 
    ...
    <!-- Java Script
    ================================================== -->
    <script src="../../assets/transcend/js/jquery-3.2.1.min.js"></script>
    <script src="../../assets/transcend/js/plugins.js"></script>
    <script src="../../assets/transcend/js/main.js"></script>
